...
const SlugRoute = async ({ params }: { params: { slug: string, name: string } }) => {
    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center mb-10">
        <div className="m-auto w-full text-center md:w-7/12">
          <p className="m-auto my-5 w-10/12 text-lg font-light text-muted-foreground md:text-base">{new Intl.DateTimeFormat("el-GR", {
            dateStyle: "full",
